...
//        $this->set_field('category_id', new CM_Field_Select_ORM(ORM::factory('Service_Category')), 2);
        ...
        $fieldgroups = array(
            'Основные данные' => array('name', 'category_id', 'position', 'url', 'active', 'images', 'content'),
